...
namespace Compass.DecompTools {
    public partial class ThisAddIn {
        ...
        void _selectFileButton_Click(CommandBarButton Ctrl, ref bool CancelDefault) {
        ...
        void _selectFolderButton_Click(CommandBarButton Ctrl, ref bool CancelDefault) {
        ...
        void _wimsBtn_Click(CommandBarButton Ctrl, ref bool CancelDefault) {
