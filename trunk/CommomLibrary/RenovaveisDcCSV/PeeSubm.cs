...
{
    public class PEESUBMBlock : BaseBlock<PeeSubmLine>
    {
    ...
    public class PeeSubmLine : BaseLine
    {
        public PeeSubmLine(string text)
        {
            LoadCamposCSV(text);
        ...
        public int CodSubm { get { return Convert.ToInt32(valores[CamposCSV[2]]); } set { valores[CamposCSV[2]] = value.ToString(); } }
