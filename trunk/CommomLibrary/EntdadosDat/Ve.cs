...
namespace Compass.CommomLibrary.EntdadosDat
{
    ...
    public class VeLine : BaseLine
    {
        ...
        public float VolumeEspera { get { return (float)this[8]; } set { this[8] = value; } }

        public override BaseField[] Campos { get { return VeCampos; } }

        static readonly BaseField[] VeCampos = new BaseField[] {
                ...
                new BaseField(15  , 15 ,"I1"    , "MeiHoraDiaInic"),//
