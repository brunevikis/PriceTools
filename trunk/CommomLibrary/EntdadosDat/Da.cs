...
{
    public class DaBlock : BaseBlock<DaLine>
    {
    ...
    public class DaLine : BaseLine
    {
        ...
        public float Retirada { get { return (float)this[8]; } set { this[8] = value; } }
        public string Comentario { get { return this[9].ToString(); } set { this[9] = value; } }

        public override BaseField[] Campos { get { return DaCampos; } }

        static readonly BaseField[] DaCampos = new BaseField[] {
                ...
                new BaseField(25  , 34 ,"F10.2"    , "RetiradaAgua"),//
                new BaseField(36  , 47 ,"A12"    , "comentario"),//
