...
namespace Compass.CommomLibrary.HidrDat {
    public class HidrBlock : BaseBlock<HidrLine> {
        //bool hidrNovo;
        //public HidrBlock(bool novo = false)
        //{
        //    hidrNovo = novo;
        //}
    ...
    public class HidrLine : BaseLine {
        ...
        public HidrLine(bool novo = false)
        {
            Size = novo == true ? 832 : 792;
        }
        ...
        public static BaseField[] _camposDouble = new BaseField[] {
            new BaseField(  1, 1, "", "Cod"          ),
            new BaseField(1,12,"A","Usina"),//
            new BaseField(25,28,"I","Sistema"),//
            new BaseField(29,32,"I","Empresa"),//
            ...
            new BaseField(49,52,"F","Vol.Vert.(hm3)"),//
            new BaseField(53,56,"F","Vol.Desv.(hm3)"),//
            new BaseField(65,72,"G","PCV(0)"),//
            new BaseField(73,80,"G","PCV(1)"),//
            new BaseField(81,88,"G","PCV(2)"),//
            new BaseField(89,96,"G","PCV(3)"),//
            new BaseField(97,104,"G","PCV(4)"),//
            new BaseField(105,112,"G","PAC(0)"),//
            new BaseField(113,120,"G","PAC(1)"),//
            new BaseField(121,128,"G","PAC(2)"),//
            new BaseField(129,136,"G","PAC(3)"),//
            new BaseField(137,144,"G","PAC(4)"),//
            new BaseField(145,148,"I","Evap.Men.(1)"),//
            new BaseField(149,152,"I","Evap.Men.(2)"),//
            new BaseField(153,156,"I","Evap.Men.(3)"),//
            new BaseField(157,160,"I","Evap.Men.(4)"),//
            new BaseField(161,164,"I","Evap.Men.(5)"),//
            new BaseField(165,168,"I","Evap.Men.(6)"),//
            new BaseField(169,172,"I","Evap.Men.(7)"),//
            new BaseField(173,176,"I","Evap.Men.(8)"),//
            new BaseField(177,180,"I","Evap.Men.(9)"),//
            new BaseField(181,184,"I","Evap.Men.(10)"),//
            new BaseField(185,188,"I","Evap.Men.(11)"),//
            new BaseField(189,192,"I","Evap.Men.(12)"),//
            new BaseField(577,580,"F","Prod.Esp.(MW/m3/s/m)"),//
            new BaseField(733,736,"F","Canal Fuga Médio(m)"),//
            new BaseField(765,768,"F","TEIF(%)"),//
            new BaseField(769,772,"F","IP(%)"),//
            new BaseField(757,760,"I","Tipo Turbina"),//
            new BaseField(193,196,"I","Num.Conj.Máq."),//
            new BaseField(585,588,"I","Num.Pols.Jus."),//
            new BaseField(741,744,"F","Fat.Carga Máx.(%)"),//
            new BaseField(745,748,"F","Fat.Carga mín.(%)"),//
            new BaseField(773,776,"I","Tipo Perdas(1=%/2=M/3=K)"),//
            new BaseField(581,584,"F","Valor Perdas"),//
            new BaseField(749,752,"I","Vazão Mín.Hist.(m3/s)"),//
            new BaseField(753,756,"I","Num.Unid.Base"),//
            new BaseField(737,740,"I","Infl.Vert.Canal de Fuga"),//
            new BaseField(761,764,"I","Rep.Conj(0=aprox/1=det/2=simp)"),//
            new BaseField(197,200,"I","#Maq(1)"),//
            new BaseField(217,220,"F","PotEf(1)"),//
            new BaseField(557,560,"I","QEf(1)"),//
            new BaseField(537,540,"F","HEf(1)"),//
            new BaseField(201,204,"I","#Maq(2)"),//
            new BaseField(221,224,"F","PotEf(2)"),//
            new BaseField(561,564,"I","QEf(2)"),//
            new BaseField(541,544,"F","HEf(2)"),//
            new BaseField(205,208,"I","#Maq(3)"),//
            new BaseField(225,228,"F","PotEf(3)"),//
            new BaseField(565,568,"I","QEf(3)"),//
            new BaseField(545,548,"F","HEf(3)"),//
            new BaseField(209,212,"I","#Maq(4)"),//
            new BaseField(229,232,"F","PotEf(4)"),//
            new BaseField(569,572,"I","QEf(4)"),//
            new BaseField(549,552,"F","HEf(4)"),//
            new BaseField(213,216,"I","#Maq(5)"),//
            new BaseField(233,236,"F","PotEf(5)"),//
            new BaseField(573,576,"I","QEf(5)"),//
            new BaseField(553,556,"F","HEf(5)"),//
            new BaseField(237,240,"F","QHTA0(1)"),//
            new BaseField(241,244,"F","QHTA1(1)"),//
            new BaseField(245,248,"F","QHTA2(1)"),//
            new BaseField(249,252,"F","QHTA3(1)"),//
            new BaseField(253,256,"F","QHTA4(1)"),//
            new BaseField(257,260,"F","QHTA0(2)"),//
            new BaseField(261,264,"F","QHTA1(2)"),//
            new BaseField(265,268,"F","QHTA2(2)"),//
            new BaseField(269,272,"F","QHTA3(2)"),//
            new BaseField(273,276,"F","QHTA4(2)"),//
            new BaseField(277,280,"F","QHTA0(3)"),//
            new BaseField(281,284,"F","QHTA1(3)"),//
            new BaseField(285,288,"F","QHTA2(3)"),//
            new BaseField(289,292,"F","QHTA3(3)"),//
            new BaseField(293,296,"F","QHTA4(3)"),//
            new BaseField(297,300,"F","QHTA0(4)"),//
            new BaseField(301,304,"F","QHTA1(4)"),//
            new BaseField(305,308,"F","QHTA2(4)"),//
            new BaseField(309,312,"F","QHTA3(4)"),//
            new BaseField(313,316,"F","QHTA4(4)"),//
            new BaseField(317,320,"F","QHTA0(5)"),//
            new BaseField(321,324,"F","QHTA1(5)"),//
            new BaseField(325,328,"F","QHTA2(5)"),//
            new BaseField(329,332,"F","QHTA3(5)"),//
            new BaseField(333,336,"F","QHTA4(5)"),//
            new BaseField(337,340,"F","QHGA0(1)"),//
            new BaseField(341,344,"F","QHGA1(1)"),//
            new BaseField(345,348,"F","QHGA2(1)"),//
            new BaseField(349,352,"F","QHGA3(1)"),//
            new BaseField(353,356,"F","QHGA4(1)"),//
            new BaseField(357,360,"F","QHGA0(2)"),//
            new BaseField(361,364,"F","QHGA1(2)"),//
            new BaseField(365,368,"F","QHGA2(2)"),//
            new BaseField(369,372,"F","QHGA3(2)"),//
            new BaseField(373,376,"F","QHGA4(2)"),//
            new BaseField(377,380,"F","QHGA0(3)"),//
            new BaseField(381,384,"F","QHGA1(3)"),//
            new BaseField(385,388,"F","QHGA2(3)"),//
            new BaseField(389,392,"F","QHGA3(3)"),//
            new BaseField(393,396,"F","QHGA4(3)"),//
            new BaseField(397,400,"F","QHGA0(4)"),//
            new BaseField(401,404,"F","QHGA1(4)"),//
            new BaseField(405,408,"F","QHGA2(4)"),//
            new BaseField(409,412,"F","QHGA3(4)"),//
            new BaseField(413,416,"F","QHGA4(4)"),//
            new BaseField(417,420,"F","QHGA0(5)"),//
            new BaseField(421,424,"F","QHGA1(5)"),//
            new BaseField(425,428,"F","QHGA2(5)"),//
            new BaseField(429,432,"F","QHGA3(5)"),//
            new BaseField(433,436,"F","QHGA4(5)"),//
            new BaseField(437,440,"F","PHA0(1)"),//
            new BaseField(441,444,"F","PHA1(1)"),//
            new BaseField(445,448,"F","PHA2(1)"),//
            new BaseField(449,452,"F","PHA3(1)"),//
            new BaseField(453,456,"F","PHA4(1)"),//
            new BaseField(457,460,"F","PHA0(2)"),//
            new BaseField(461,464,"F","PHA1(2)"),//
            new BaseField(465,468,"F","PHA2(2)"),//
            new BaseField(469,472,"F","PHA3(2)"),//
            new BaseField(473,476,"F","PHA4(2)"),//
            new BaseField(477,480,"F","PHA0(3)"),//
            new BaseField(481,484,"F","PHA1(3)"),//
            new BaseField(485,488,"F","PHA2(3)"),//
            new BaseField(489,492,"F","PHA3(3)"),//
            new BaseField(493,496,"F","PHA4(3)"),//
            new BaseField(497,500,"F","PHA0(4)"),//
            new BaseField(501,504,"F","PHA1(4)"),//
            new BaseField(505,508,"F","PHA2(4)"),//
            new BaseField(509,512,"F","PHA3(4)"),//
            new BaseField(513,516,"F","PHA4(4)"),//
            new BaseField(533,536,"F","PHA4(5)"),/////////
            new BaseField(517,520,"F","PHA0(5)"),//
            new BaseField(521,524,"F","PHA1(5)"),//
            new BaseField(525,528,"F","PHA2(5)"),//
            new BaseField(529,532,"F","PHA3(5)"),//
            new BaseField(589,592,"F","PJA0(1)"),//
            new BaseField(593,596,"F","PJA1(1)"),//
            new BaseField(597,600,"F","PJA2(1)"),//
            new BaseField(601,604,"F","PJA3(1)"),//
            new BaseField(605,608,"F","PJA4(1)"),//
            new BaseField(709,712,"F","PJRM(1)"),//
            new BaseField(609,612,"F","PJA0(2)"),//
            new BaseField(613,616,"F","PJA1(2)"),//
            new BaseField(617,620,"F","PJA2(2)"),//
            new BaseField(621,624,"F","PJA3(2)"),//
            new BaseField(625,628,"F","PJA4(2)"),//
            new BaseField(713,716,"F","PJRM(2)"),//
            new BaseField(629,632,"F","PJA0(3)"),//
            new BaseField(633,636,"F","PJA1(3)"),//
            new BaseField(637,640,"F","PJA2(3)"),//
            new BaseField(641,644,"F","PJA3(3)"),//
            new BaseField(645,648,"F","PJA4(3)"),//
            new BaseField(717,720,"F","PJRM(3)"),//
            new BaseField(649,652,"F","PJA0(4)"),//
            new BaseField(653,656,"F","PJA1(4)"),//
            new BaseField(657,660,"F","PJA2(4)"),//
            new BaseField(661,664,"F","PJA3(4)"),//
            new BaseField(665,668,"F","PJA4(4)"),//
            new BaseField(721,724,"F","PJRM(4)"),//
            new BaseField(669,672,"F","PJA0(5)"),//
            new BaseField(673,676,"F","PJA1(5)"),//
            new BaseField(677,680,"F","PJA2(5)"),//
            new BaseField(681,684,"F","PJA3(5)"),//
            new BaseField(685,688,"F","PJA4(5)"),//
            new BaseField(725,728,"F","PJRM(5)"),//
            new BaseField(777,784,"A","Data"),//
            new BaseField(785,827,"A","Obs"),//
            new BaseField(828,831,"F","Vol.Ref."),//
            new BaseField(832,832,"A","Reg"),//
        ...
        public double PCV0 { get { return this["PCV(0)"]; } set { this["PCV(0)"] = value; } }
        public double PCV1 { get { return this["PCV(1)"]; } set { this["PCV(1)"] = value; } }
        public double PCV2 { get { return this["PCV(2)"]; } set { this["PCV(2)"] = value; } }
        public double PCV3 { get { return this["PCV(3)"]; } set { this["PCV(3)"] = value; } }
        public double PCV4 { get { return this["PCV(4)"]; } set { this["PCV(4)"] = value; } }
