...
{
    public class GeracaoBlock : BaseBlock<GeracaoLine>
    {
    ...
    public class GeracaoLine : BaseLine
    {
        System.Globalization.CultureInfo Culture = System.Globalization.CultureInfo.InvariantCulture;

        public GeracaoLine(string text)
        {
            LoadCamposCSV(text);
        ...
        public double PU { get { return Convert.ToDouble((string)valores[CamposCSV[5]],Culture.NumberFormat); } set { valores[CamposCSV[5]] = value.ToString(Culture.NumberFormat); } }
