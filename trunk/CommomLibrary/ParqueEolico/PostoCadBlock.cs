...
{
    public class PostoCadBlock : BaseBlock<PostoCadLine>
    {
    ...
    public class PostoCadLine : BaseLine
    {
        public PostoCadLine(string text)
        {
            LoadCamposCSV(text);
        ...
        public int CodPostoVento { get { return Convert.ToInt32(valores[CamposCSV[1]]); } set { valores[CamposCSV[1]] = value.ToString(); } }
        public int NomePostoVento { get { return Convert.ToInt32(valores[CamposCSV[2]]); } set { valores[CamposCSV[2]] = value.ToString(); } }
