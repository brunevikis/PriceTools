...
{
    public class IndicesGevazp : BaseDocument
    {
        Dictionary<string, IBlock<BaseLine>> blocos = new Dictionary<string, IBlock<BaseLine>>() {
                    {"PARQUE-EOLICO-EQUIVALENTE"             , new IndicesGevazpBlock()},
                };
        ...
        public IndicesGevazpBlock BlocoIndiceGevazp { get { return (IndicesGevazpBlock)Blocos["PARQUE-EOLICO-EQUIVALENTE"]; } set { Blocos["PARQUE-EOLICO-EQUIVALENTE"] = value; } }
