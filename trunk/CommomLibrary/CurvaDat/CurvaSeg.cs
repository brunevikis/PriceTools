...
namespace Compass.CommomLibrary.CurvaDat
{
    ...
    public class CurvaSegPorLine : CurvaSegLine
    {
        public static readonly new BaseField[] campos = new BaseField[] {
                ...
                new BaseField( 7 ,  11 ,"F5.1"  ,  "Porc Mes 1"),
                new BaseField( 13 , 17 ,"F5.1"  ,  "Porc Mes 2"),
                new BaseField( 19 , 23 ,"F5.1"  ,  "Porc Mes 3"),
                new BaseField( 25 , 29 ,"F5.1"  ,  "Porc Mes 4"),
                new BaseField( 31 , 35 ,"F5.1"  ,  "Porc Mes 5"),
                new BaseField( 37 , 41 ,"F5.1"  ,  "Porc Mes 6"),
                new BaseField( 43 , 47 ,"F5.1"  ,  "Porc Mes 7"),
                new BaseField( 49 , 53 ,"F5.1"  ,  "Porc Mes 8"),
                new BaseField( 55 , 59 ,"F5.1"  ,  "Porc Mes 9"),
                new BaseField( 61 , 65 ,"F5.1"  ,  "Porc Mes 10"),
                new BaseField( 67 , 71 ,"F5.1"  ,  "Porc Mes 11"),
                new BaseField( 73 , 77 ,"F5.1"  , "Porc Mes 12"),
