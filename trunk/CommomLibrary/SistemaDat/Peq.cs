...
";
    ...
    public class PeqEneLine : PeqLine
    {
        public static readonly new BaseField[] campos = new BaseField[] {
                ...
                new BaseField( 8 ,  14 ,"f7.2"  ,  "Mercado Mes 1"),
                new BaseField( 16 , 22 ,"f7.2"  ,  "Mercado Mes 2"),
                new BaseField( 24 , 30 ,"f7.2"  ,  "Mercado Mes 3"),
                new BaseField( 32 , 38 ,"f7.2"  ,  "Mercado Mes 4"),
                new BaseField( 40 , 46 ,"f7.2"  ,  "Mercado Mes 5"),
                new BaseField( 48 , 54 ,"f7.2"  ,  "Mercado Mes 6"),
                new BaseField( 56 , 62 ,"f7.2"  ,  "Mercado Mes 7"),
                new BaseField( 64 , 70 ,"f7.2"  ,  "Mercado Mes 8"),
                new BaseField( 72 , 78 ,"f7.2"  ,  "Mercado Mes 9"),
                new BaseField( 80 , 86 ,"f7.2"  ,  "Mercado Mes 10"),
                new BaseField( 88 , 94 ,"f7.2"  ,  "Mercado Mes 11"),
                new BaseField( 96 , 102 ,"f7.2"  , "Mercado Mes 12"),
