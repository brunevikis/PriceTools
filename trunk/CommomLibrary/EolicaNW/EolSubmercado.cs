...
{
    public class EolSubmercado: BaseDocument
    {
        Dictionary<string, IBlock<BaseLine>> blocos = new Dictionary<string, IBlock<BaseLine>>() {
                    {"PEE-SUBM"             , new EolSubmBlock()},
                };
        ...
        public EolSubmBlock BlocoEolSubm { get { return (EolSubmBlock)Blocos["PEE-SUBM"]; } set { Blocos["PEE-SUBM"] = value; } }
