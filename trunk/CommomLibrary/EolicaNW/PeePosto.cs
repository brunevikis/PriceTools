...
{
    public class PeePostBlock: BaseBlock<PeePostLine>
    {
    ...
    public class PeePostLine : BaseLine
    {
        public PeePostLine(string text)
        {
            LoadCamposCSV(text);
        ...
        public int CodSPosto { get { return Convert.ToInt32(valores[CamposCSV[2]]); } set { valores[CamposCSV[2]] = value.ToString(); } }
