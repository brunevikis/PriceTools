...
{
    public class PostVentBlock : BaseBlock<PostVentLine>
    {
    ...
    public class PostVentLine : BaseLine
    {
        public PostVentLine(string text)
        {
            LoadCamposCSV(text);
        ...
        public int CodPosto { get { return Convert.ToInt32(valores[CamposCSV[1]]); } set { valores[CamposCSV[1]] = value.ToString(); } }
        public string NomePosto { get { return valores[CamposCSV[2]]; } set { valores[CamposCSV[2]] = value.ToString(); } }
