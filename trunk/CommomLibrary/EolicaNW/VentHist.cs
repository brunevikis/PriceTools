...
{
    public class VentHistBlock : BaseBlock<VentHistLine>
    {
    ...
    public class VentHistLine : BaseLine
    {
        System.Globalization.CultureInfo Culture = System.Globalization.CultureInfo.InvariantCulture;

        public VentHistLine(string text)
        {
            LoadCamposCSV(text);
        ...
        public int PEEPosto { get { return Convert.ToInt32(valores[CamposCSV[1]]); } set { valores[CamposCSV[1]] = value.ToString(); } }
        ...
        public double Velocidade { get { return Convert.ToDouble((string)valores[CamposCSV[4]], Culture.NumberFormat); } set { valores[CamposCSV[4]] = value.ToString(Culture.NumberFormat); } }
        public double Direcao { get { return Convert.ToDouble((string)valores[CamposCSV[5]], Culture.NumberFormat); } set { valores[CamposCSV[5]] = value.ToString(Culture.NumberFormat); } }
