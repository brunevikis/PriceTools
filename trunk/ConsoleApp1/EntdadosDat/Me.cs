...
namespace ConsoleApp1.EntdadosDat
{
    ...
    public class MeLine : BaseLine
    {
        ...
        public float FatorDisp { get { return (float)this[8]; } set { this[8] = value; } }

        public override BaseField[] Campos { get { return MeCampos; } }

        static readonly BaseField[] MeCampos = new BaseField[] {
                ...
                new BaseField(25  , 34 ,"F10.0"    , "FatorDisp"),//
