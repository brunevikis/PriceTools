...
{
    public class DfBlock : BaseBlock<DfLine>
    {
    ...
    public class DfLine : BaseLine
    {
        ...
        public float TaxaDescarga { get { return (float)this[8]; } set { this[8] = value; } }

        public override BaseField[] Campos { get { return DfCampos; } }

        static readonly BaseField[] DfCampos = new BaseField[] {
                ...
                new BaseField(25  , 34 ,"F10.0"    , "TaxaDescarga"),//
