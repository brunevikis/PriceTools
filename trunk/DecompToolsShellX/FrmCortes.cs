    ...
    public partial class FrmCortes : Form
    {
        ...
        public void OK(bool automatico = false)
        {
            if (automatico)
            {
                ...
                //@"L:\6_decomp\03_Casos\2019_05\NW201905 - Resultados"
                ...
                if (Directory.Exists($@"K:\4_curto_prazo\{datadeck:yyyy_MM}\NW{datadeck:yyyyMM}-Resultados"))
                {
                    //path = $@"L:\6_decomp\03_Casos\{datadeck:yyyy_MM}\NW{datadeck:yyyyMM}-Resultados";
                    path = $@"K:\4_curto_prazo\{datadeck:yyyy_MM}\NW{datadeck:yyyyMM}-Resultados";
                    //else if (Directory.Exists($@"L:\6_decomp\03_Casos\{datadeck:yyyy_MM}\deck_newave_{datadeck:yyyy_MM}_ccee"))
                }
                else if (Directory.Exists($@"K:\4_curto_prazo\{datadeck:yyyy_MM}\NW{datadeck:yyyyMM}-Resultado"))
                {
                    //path = $@"L:\6_decomp\03_Casos\{datadeck:yyyy_MM}\NW{datadeck:yyyyMM}-Resultados";
                    path = $@"K:\4_curto_prazo\{datadeck:yyyy_MM}\NW{datadeck:yyyyMM}-Resultado";
                    //else if (Directory.Exists($@"L:\6_decomp\03_Casos\{datadeck:yyyy_MM}\deck_newave_{datadeck:yyyy_MM}_ccee"))
                }
                else if (Directory.Exists($@"K:\4_curto_prazo\{datadeck:yyyy_MM}\deck_newave_{datadeck:yyyy_MM}_ccee"))
                {
                    //path = $@"L:\6_decomp\03_Casos\{datadeck:yyyy_MM}\deck_newave_{datadeck:yyyy_MM}_ccee";
                    path = $@"K:\4_curto_prazo\{datadeck:yyyy_MM}\deck_newave_{datadeck:yyyy_MM}_ccee";
                }
                else
                {
                    var i = 1;
                    ...
                    do
                    {
                        ...
                        nwDir = $@"K:\4_curto_prazo\{datadeck:yyyy_MM}\deck_newave_{datadeck:yyyy_MM}_ccee ({i++})";
