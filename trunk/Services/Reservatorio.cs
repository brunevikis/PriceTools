...
namespace Compass.Services {
    public class Reservatorio {
        ...
        public static void SetUHBlockREE(ConfigH configH, double[] earmTargetLevel, double[] earmMax, List<Infosheet.Dados_Fixa> Fixa_UH)
        {
            var earmTarget = new double[earmTargetLevel.Length];
            ...
            {
                //UhBlock uhResult = 
                buildReservREE(configH, earmTarget, earmMax, Fixa_UH);
                //((Dadger)configH.baseDoc).BlocoUh = uhResult;
            }
            else if (configH.baseDoc is EntdadosDat)
            {
        ...
        static void buildReservFixado(ConfigH configH, double[] earmTarget, double[] earmMax, List<WorkbookMensal.Dados_Fixa> Fixa_UH = null)
        {
            ...
            {
                //ordenação deve obedecer a proveniente do deckBase.uh
                foreach (var uhBase in ((EntdadosDat)configH.baseDoc).BlocoUh)
                {
        ...
        public static Boolean Meta_Fixa_UhFixado(ConfigH configH, double[] earmTarget, double[] earm_Max, List<WorkbookMensal.Dados_Fixa> Fixa_UH = null)
        {
            if (configH.baseDoc is Dadger)
            {
                foreach (var uhBase in ((Dadger)configH.baseDoc).BlocoUh)
