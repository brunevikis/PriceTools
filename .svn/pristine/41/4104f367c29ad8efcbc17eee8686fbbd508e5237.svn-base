...
namespace Compass.CommomLibrary.PatamarDat {
...
";
    ...
    public class CargaEneLine : CargaLine {
        public static readonly new BaseField[] campos = new BaseField[] {
                new BaseField( 1 , 7 ,"I4"  , "Ano"),
                new BaseField( 8 ,  14 ,"F7.4"  ,  "1"),
                new BaseField( 15 , 21 ,"F7.4"  ,  "2"),
                new BaseField( 22 , 28 ,"F7.4"  ,  "3"),
                new BaseField( 29 , 35 ,"F7.4"  ,  "4"),
                new BaseField( 36 , 42 ,"F7.4"  ,  "5"),
                new BaseField( 43 , 49 ,"F7.4"  ,  "6"),
                new BaseField( 50 , 56 ,"F7.4"  ,  "7"),
                new BaseField( 57 , 63 ,"F7.4"  ,  "8"),
                new BaseField( 64 , 70 ,"F7.4"  ,  "9"),
                new BaseField( 71 , 77 ,"F7.4"  ,  "10"),
                new BaseField( 78 , 84 ,"F7.4"  ,  "11"),
                new BaseField( 85 , 91 ,"F7.4"  , "12"),
        ...
        public int Patamar { get { return this["Patamar"]; } set { this["Patamar"] = value; } }
        public int Mercado { get { return this["Submercado"]; } set { this["Submercado"] = value; } }
...
";
    ...
    public class IntABLine : IntLine {
        public static readonly new BaseField[] campos = new BaseField[] {
                new BaseField( 1 , 7 ,"I4"  , "Ano"),
                new BaseField( 8  , 14,"F7.4"  ,  "Intercambio 1"),
                new BaseField( 15 , 21,"F7.4"  ,  "Intercambio 2"),
                new BaseField( 22 , 28,"F7.4"  ,  "Intercambio 3"),
                new BaseField( 29 , 35,"F7.4"  ,  "Intercambio 4"),
                new BaseField( 36 , 42,"F7.4"  ,  "Intercambio 5"),
                new BaseField( 43 , 49,"F7.4"  ,  "Intercambio 6"),
                new BaseField( 50 , 56,"F7.4"  ,  "Intercambio 7"),
                new BaseField( 57 , 63,"F7.4"  ,  "Intercambio 8"),
                new BaseField( 64 , 70,"F7.4"  ,  "Intercambio 9"),
                new BaseField( 71 , 77,"F7.4"  ,  "Intercambio 10"),
                new BaseField( 78 , 84,"F7.4"  ,  "Intercambio 11"),
                new BaseField( 85 , 91,"F7.4"  ,  "Intercambio 12"),     
